 ...
 * functionality, then refer to `class-buooy-sticky-header-admin.php`
 *
...
class Buooy_Sticky_Header {
	 ...
	 * @var      string
	 */
	protected $plugin_slug = 'buooy-sticky-header';
	...
	private function __construct() {
		...
		if( $sticky_header['bsh-include-default-css'] ) { add_action( 'wp_enqueue_scripts', array( $this, 'enqueue_styles' ) ); }
